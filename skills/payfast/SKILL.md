---
name: payfast
description: PayFast (SA) integration — generate form-post MD5 signatures in the documented field order with URL-encoded values, and verify ITN POST signatures using the same algorithm.
metadata:
  targets: [claude, cursor, copilot, codex, gemini]
sources:
  - url: https://developers.payfast.co.za/docs#checkout_security
    retrieved: 2026-06-07
  - url: https://developers.payfast.co.za/docs#itn
    retrieved: 2026-06-07
  - url: https://developers.payfast.co.za/docs#quickstart
    retrieved: 2026-06-07
---
